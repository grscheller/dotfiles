...
function M.lsp_kb(client, bufnr)
   ...
   vim.keymap.set('n', 'zqe', function() vim.diagnostic.setqflist { severity = 'E' } end,
      { desc = 'qf list ws errors', buffer = bufnr })
   vim.keymap.set('n', 'zqw', function() vim.diagnostic.setqflist { severity = 'W' } end,
   ...
   vim.keymap.set('n', '[', function() vim.diagnostic.goto_prev { wrap = false } end,
      { desc = 'diagnostic goto previous', buffer = bufnr })
   vim.keymap.set('n', ']', function() vim.diagnostic.goto_next { wrap = false } end,
