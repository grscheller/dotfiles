...
# upon system logon via a login shell.  Other configurations, like
# functions and aliases, were configured by .bashrc.  Sourcing .bashrc,
# as is done below, ensures login shells have these other configurations
# gotten by non-login interactive shells. 
#
# Unfortunately, I have had to put a mechanism into .bashrc to ensure
# that a consistent initial software development environment has been
# configured.  This is due to certain display managers invoking entire
# desktop environments without ever going through a login shell.
# 
