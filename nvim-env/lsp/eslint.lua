--[[ LSP Configuration JS/TS - vscode-eslint-language-server ]]
...
return {
   ...
   settings = {
      ...
      -- nodePath configures the directory in which the eslint server should start its node_modules
      -- resolution. This path is relative to the workspace folder (root dir) of the server instance.
      nodePath = '',
      -- Use the workspace folder location or the file location (if no workspace folder is open) as
