...
--local augroup = vim.api.nvim_create_augroup local autocmd
--= vim.api.nvim_create_autocmd local usercmd = vim.api.nvim_create_user_command
--
...
-- kb({ 'n', 'x' }, ' d', '"_d', { desc = 'delete text to blackhole register',
-- }) kb({ 'n', 'x' }, ' c', '"_c', { desc = 'change text to blackhole
-- register', })
-- 
